...
// * 成绩管理
// */
//class SpScoreUtil @SuppressLint("CommitPrefEdits") constructor(context: Context, name: String?) {
...
//    // 是否有记录-false-否
//    var isScore: Boolean
//        get() = mSharedPreferences.getBoolean(SCORE_BOOLEAN, false)
//        set(isScore) {
...
//    // 读档次数
//    var load: Int?
//        get() = mSharedPreferences.getInt(SCORE_LOAD, 9)
//        set(load) {
...
//    // 健康
//    var healthy: Int
//        get() = mSharedPreferences.getInt(SCORE_HEALTHY, 200)
//        set(healthy) {
//            editor.putInt(SCORE_HEALTHY, healthy + healthy)
//            editor.commit()
//        }
//
//
//    // 能力
//    var ability: Int
//        get() = mSharedPreferences.getInt(SCORE_ABILITY, 100)
//        set(ability) {
//            editor.putInt(SCORE_ABILITY, ability + ability)
//            editor.commit()
//        }
//
//    // 经验
//    var experience: Int
//        get() = mSharedPreferences.getInt(SCORE_EXPERIENCE, 100)
//        set(experience) {
//            editor.putInt(SCORE_EXPERIENCE, experience + experience)
//            editor.commit()
//        }
//
//    // 快乐
//    var happy: Int
//        get() = mSharedPreferences.getInt(SCORE_HAPPY, 200)
//        set(happy) {
//            editor.putInt(SCORE_HAPPY, happy + happy)
//            editor.commit()
//        }
//
//    // 道德
//    var morality: Int
//        get() = mSharedPreferences.getInt(SCORE_MORALITY, 200)
//        set(morality) {
//            editor.putInt(SCORE_MORALITY, morality + morality)
//            editor.commit()
//        }
//
//    // 交际
//    var communication: Int
//        get() = mSharedPreferences.getInt(SCORE_COMMUNICATION, 100)
//        set(communication) {
//            editor.putInt(SCORE_COMMUNICATION, communication + communication)
//            editor.commit()
//        }
//
//    // 剩余月
//    var month: Int
//        get() = mSharedPreferences.getInt(SCORE_MONTH, 96)
//        set(month) {
//            editor.putInt(SCORE_MONTH, month + month)
//            editor.commit()
//        }
//
//    // 剩余时间
//    var time: Int
//        get() = mSharedPreferences.getInt(SCORE_TIME, 230)
//        set(time) {
//            if (time == 0) {
//                editor.putInt(SCORE_TIME, 230)
//            } else {
//                editor.putInt(SCORE_TIME, time + time)
//            }
//            editor.commit()
//        }
//
...
//        set(stock) {
//            editor.putInt(SCORE_STOCK, stock + stock)
//            editor.commit()
//        }
//
//    // 职位
...
//    //事业指数
//    var career: Int
//        get() = mSharedPreferences.getInt(SCORE_CAREER, 1)
//        set(career) {
//            editor.putInt(SCORE_CAREER, career + career)
//            editor.commit()
//        }
//
//    //爱情指数
//    var love: Int
//        get() = mSharedPreferences.getInt(SCORE_LOVE, 1)
//        set(love) {
//            editor.putInt(SCORE_LOVE, love + love)
//            editor.commit()
//        }
//
//    //随机股票指数
//    var randomStock: Int?
//        get() = mSharedPreferences.getInt(SCORE_RANDOM_STOCK, 100)
//        set(random_stock) {
...
//    //房价指数
//    var indexHouse: Int?
//        get() = mSharedPreferences.getInt(SCORE_INDEX_HOUSE, 100)
//        set(index_house) {
...
//    //股票指数
//    var indexStock: Int
//        get() = mSharedPreferences.getInt(SCORE_INDEX_STOCK, 1700)
//        set(index_stock) {
...
//    // 分数含金量
//    var purity: Int
//        get() = mSharedPreferences.getInt(SCORE_PURITY, 100)
//        set(purity) {
//            editor.putInt(SCORE_PURITY, purity + purity)
//            editor.commit()
//        }
//
//    // 月净收益
//    var income: Int
//        get() = mSharedPreferences.getInt(SCORE_INCOME, 2200)
//        set(income) {
//            editor.putInt(SCORE_INCOME, income + income)
//            editor.commit()
//        }
//
//    // 月净交际
...
//            editor.putInt(SCORE_COMMUNICATION_MONTHLY, communicationMonthly + communicationMonthly)
//            editor.commit()
//        }
//
//    // 月净快乐
//    var happyMonthly: Int
//        get() = mSharedPreferences.getInt(SCORE_HAPPY_MONTHLY, -2)
//        set(happyMonthly) {
//            editor.putInt(SCORE_HAPPY_MONTHLY, happyMonthly + happyMonthly)
//            editor.commit()
//        }
//
//    //股票 0/1
...
//
//    var partnerSn: Int
//        get() = mSharedPreferences.getInt(PARTNER_SN, 0)
//        set(partner_sn) {
//            editor.putInt(PARTNER_SN, partner_sn)
//            editor.commit()
//        }
//
//    var partnerSnTime: Int
//        get() = mSharedPreferences.getInt(PARTNER_SN_TIME, 0)
//        set(partner_sn_time) {
//            editor.putInt(PARTNER_SN_TIME, partnerSnTime.plus(partner_sn_time))
//            editor.commit()
//        }
//
...
//        private const val SCORE_LOAD = "score_load" //读档次数
