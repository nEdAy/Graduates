...
//        dialog.show();
//        ListView mlist = parentView.findViewById(R.id.id_top);
//        adapter = new LazyAdapter(getActivity(), items);
//        mlist.setAdapter(adapter);
//        my_rank = parentView.findViewById(R.id.my_rank);
//        my_score = parentView.findViewById(R.id.my_score);
//        count = parentView.findViewById(R.id.count);
//    }
//
